...
public class ClassStudentListAdapter extends RecyclerView.Adapter<ClassStudentListAdapter.MyViewHolder> {
    ...
    OnRateListner onCardRateListner;
    OnChatListner onCardChatListner;
    OnMaliListner onCardMaliListner;
      ...
      /*  if(!ClassStudentListModel.getHeader()){
        ...
        if(!ClassStudentListModel.getHeader()){
            holder.contact.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onCardChatListner.OnChated(v, position,moviesList);
                }
            });
            ...
            holder.star.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onCardRateListner.OnRateed(v, position,moviesList);
                }
            });



            holder.dollar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onCardMaliListner.OnMalied(v, position,moviesList);
                }
            });
        }
    ...
    public interface OnRateListner {
        void OnRateed(View view, int position, List<ClassStudentListModel> moviesList);
    }

    public void setOnRateListner(OnRateListner onCardRateListner) {
        this.onCardRateListner = onCardRateListner;
    }
    public interface OnChatListner {
        void OnChated(View view, int position, List<ClassStudentListModel> moviesList);
    }

    public void setOnChatListner(OnChatListner onCardChatListner) {
        this.onCardChatListner = onCardChatListner;
    }
    public interface OnMaliListner {
        void OnMalied(View view, int position, List<ClassStudentListModel> moviesList);
    }

    public void setOnMaliListner(OnMaliListner onCardMaliListner) {
        this.onCardMaliListner = onCardMaliListner;
    }
}
