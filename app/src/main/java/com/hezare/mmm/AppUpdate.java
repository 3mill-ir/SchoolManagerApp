...
public class AppUpdate {
    ...
    public void check_Version() throws PackageManager.NameNotFoundException {
        ...
        String url = "http://3mill.ir/download/appcheck?path=mobile/android/solda/moaven&secretKey=3mill186";
                        ...
                        if (compareVersionNames(version, availableVersion) == -1) {
                            ...
                            builder.setPositiveButton("آره", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    intent.putExtra("url", "http://3mill.ir/download/AppSend?path=mobile/android/solda/moaven&secretkey=3mill186");
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == DownloadService.UPDATE_PROGRESS) {
                ...
                if (progress == 100) {
                    ...
                    intent.setDataAndType(Uri.fromFile(new File(Environment.getExternalStorageDirectory().getPath() + "/soldamoven.apk")), "application/vnd.android.package-archive");
